/* Generated by Cython 0.20.1 on Sat Dec  6 16:57:33 2014 */
...
static char __pyx_k_d_git_mypylab_cython_helloworld[] = "/d/git/mypylab/cython/helloworld/hello.pyx";
static PyObject *__pyx_kp_s_Hello_World;
static PyObject *__pyx_kp_s_d_git_mypylab_cython_helloworld;
...
static PyMethodDef __pyx_mdef_5hello_1say_hello = {__Pyx_NAMESTR("say_hello"), (PyCFunction)__pyx_pw_5hello_1say_hello, METH_NOARGS, __Pyx_DOCSTR(0)};
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_kp_s_d_git_mypylab_cython_helloworld, __pyx_k_d_git_mypylab_cython_helloworld, sizeof(__pyx_k_d_git_mypylab_cython_helloworld), 0, 0, 1, 0},
 ...
 *     print "Hello World!"
 */
  __pyx_codeobj_ = (PyObject*)__Pyx_PyCode_New(0, 0, 0, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_d_git_mypylab_cython_helloworld, __pyx_n_s_say_hello, 2, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj_)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 2; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#endif
{
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "hello")) {
      if (unlikely(PyDict_SetItemString(modules, "hello", __pyx_m) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 2; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 *     print "Hello World!"
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_5hello_1say_hello, NULL, __pyx_n_s_hello); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 2; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_say_hello, __pyx_t_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 2; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
